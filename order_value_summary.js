...
(function() {
    ...
    var elements = document.querySelectorAll("div.explorer_container td.amountTD");
    ...
    if (title) {
        title.textContent = 'รายการสั่งซื้อสินค้า (รวม ' + numberWithCommas(totalOrderValue) + ' บาท)'
    }
})();